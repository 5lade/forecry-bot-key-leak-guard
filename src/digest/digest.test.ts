...
import { generateDailyDigest, renderTelegramDigest, type DailyDigestInput } from './digest.js';

const fixture = JSON.parse(readFileSync(resolve(process.cwd(), 'test/fixtures/daily-digest.json'), 'utf8')) as DailyDigestInput;
