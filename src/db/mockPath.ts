import type { AccountRecord, FindingRecord, IncidentRecord, RepositoryRecord, WorkspaceRecord } from '../domain/types.js';

export interface DemoRecordPath {
...
export function createDemoRecordPath(): DemoRecordPath {
